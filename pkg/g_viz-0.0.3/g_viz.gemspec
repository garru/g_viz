...
Gem::Specification.new do |s|
  ...
  s.email = %q{}
  s.extra_rdoc_files = ["CHANGELOG", "lib/g_viz/data.rb", "lib/g_viz/g_viz.rb", "lib/g_viz/json_google.rb", "lib/g_viz/templates/data_tables.erb", "lib/g_viz/templates/visualization.erb", "lib/g_viz.rb", "README.markdown"]
  s.files = ["CHANGELOG", "lib/g_viz/data.rb", "lib/g_viz/g_viz.rb", "lib/g_viz/json_google.rb", "lib/g_viz/templates/data_tables.erb", "lib/g_viz/templates/visualization.erb", "lib/g_viz.rb", "Manifest", "Rakefile", "README.markdown", "spec/g_viz/fixtures/annotated_timeline.rb", "spec/g_viz/g_viz_spec.rb", "spec/g_viz/templates/rendered_annotated_timeline.html", "spec/test_helper.rb", "g_viz.gemspec"]
  s.has_rdoc = true
